...
all_Apr_Oct_do_his=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_his_Jv_"):
        ...
        all_Apr_Oct_do_his = pd.concat([all_Apr_Oct_do_his , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_gfdl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
        
        header_df = pd.DataFrame([header_values])
        header_df.to_csv(os.path.join(directory, result_filename))#, index=False)
       

        result.to_csv(os.path.join(directory, result_filename) , mode='a' , index_label='year', na_rep='NaN', header=['Apr_Oct_hypolimnetic_ave'])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_hadgem_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_ipsl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_miroc_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Apr_Oct_do_his

anova_Apr_Oct_do_his=annova_uncertainity(all_Apr_Oct_do_his)

anova_Apr_Oct_do_his.describe().loc['mean', :]
"""
GCMs             82.941560
param            16.147942
interaction       0.910498
GCMs/param       14.162552
year           1933.000000
Name: mean, dtype: float64
"""


anova_Apr_Oct_do_his.describe().loc['std', :]
"""
GCMs           16.626141
param          15.616877
interaction     1.464529
GCMs/param     20.437907
year           42.001984
Name: std, dtype: float64
"""
...
#%% GLUE method on all_Apr_Oct_do_his 
          

        
#all_Apr_Oct_do_his= all_Apr_Oct_do_his.set_index(all_Apr_Oct_do_his['Datetime'])


# Apr_Oct anoxic duration  
timeseries_year_his= all_Apr_Oct_do_his.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Apr_Oct_do_his.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/his/glue_Apr_Oct_hypolimnetic_ave_his.csv')
...
all_Apr_Oct_do_rcp26=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp26_Jv_"):
        ...
        all_Apr_Oct_do_rcp26 = pd.concat([all_Apr_Oct_do_rcp26 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_gfdl_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_hadgem_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_ipsl_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_miroc_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Apr_Oct_do_rcp26

anova_Apr_Oct_do_rcp26=annova_uncertainity(all_Apr_Oct_do_rcp26)

anova_Apr_Oct_do_rcp26.describe().loc['mean', :]
"""
GCMs             81.231174
param            17.977828
interaction       0.790997
GCMs/param        8.776117
year           2052.500000
Name: mean, dtype: float64
"""
...
anova_Apr_Oct_do_rcp26.describe().loc['std', :]
"""
GCMs           15.092820
param          14.472780
interaction     0.927349
GCMs/param      8.991007
year           27.279418
Name: std, dtype: float64
"""
...
#80 years:
anova_Apr_Oct_80years_AF_rcp26=annova_uncertainity(all_Apr_Oct_do_rcp26[all_Apr_Oct_do_rcp26.index>2019])


anova_Apr_Oct_80years_AF_rcp26.describe().loc['mean', :]
"""
GCMs             82.608954
param            16.661821
interaction       0.729225
GCMs/param        9.390738
year           2059.500000
Name: mean, dtype: float64
"""
...
anova_Apr_Oct_80years_AF_rcp26.describe().loc['std', :]

"""
GCMs           13.665321
param          13.251421
interaction     0.741660
GCMs/param      9.429883
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Apr_Oct_do_rcp26 
          

        
#all_Apr_Oct_do_rcp26= all_Apr_Oct_do_rcp26.set_index(all_Apr_Oct_do_rcp26['Datetime'])


# Apr_Oct anoxic duration  
timeseries_year_rcp26= all_Apr_Oct_do_rcp26.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Apr_Oct_do_rcp26.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp26/glue_df_Apr_Oct_hypolimnetic_ave_rcp26.csv')
...
all_Apr_Oct_do_rcp60=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp60_Jv_"):
        ...
        all_Apr_Oct_do_rcp60 = pd.concat([all_Apr_Oct_do_rcp60 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_gfdl_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_hadgem_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_ipsl_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_miroc_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Apr_Oct_do_rcp60

anova_Apr_Oct_do_rcp60=annova_uncertainity(all_Apr_Oct_do_rcp60)

anova_Apr_Oct_do_rcp60.describe().loc['mean', :]
"""
GCMs             83.494628
param            15.678031
interaction       0.827341
GCMs/param       13.206457
year           2052.500000
Name: mean, dtype: float64
"""


anova_Apr_Oct_do_rcp60.describe().loc['std', :]
"""
GCMs           16.327380
param          15.424645
interaction     1.132061
GCMs/param     16.126704
year           27.279418
Name: std, dtype: float64
"""
#80 years:
anova_Apr_Oct_80years_AF_rcp60=annova_uncertainity(all_Apr_Oct_do_rcp60[all_Apr_Oct_do_rcp60.index>2019])


anova_Apr_Oct_80years_AF_rcp60.describe().loc['mean', :]
"""
GCMs             83.774226
param            15.402023
interaction       0.823751
GCMs/param       12.723150
year           2059.500000
Name: mean, dtype: float64
"""


anova_Apr_Oct_80years_AF_rcp60.describe().loc['std', :]

"""
GCMs           16.450112
param          15.550089
interaction     1.151885
GCMs/param     15.003792
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Apr_Oct_do_rcp60 
          

        
#all_Apr_Oct_do_rcp60= all_Apr_Oct_do_rcp60.set_index(all_Apr_Oct_do_rcp60['Datetime'])


# Apr_Oct anoxic duration  
timeseries_year_rcp60= all_Apr_Oct_do_rcp60.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Apr_Oct_do_rcp60.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp60/glue_df_Apr_Oct_hypolimnetic_ave_rcp60.csv')
...
all_Apr_Oct_do_rcp85=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp85_Jv_"):
        ...
        all_Apr_Oct_do_rcp85 = pd.concat([all_Apr_Oct_do_rcp85 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_gfdl_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_hadgem_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_ipsl_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Apr_Oct_hypolimnetic_ave_miroc_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Apr_Oct_do_rcp85

anova_Apr_Oct_do_rcp85=annova_uncertainity(all_Apr_Oct_do_rcp85)

anova_Apr_Oct_do_rcp85.describe().loc['mean', :]
"""
GCMs             89.905778
param             9.502104
interaction       0.592117
GCMs/param       19.158340
year           2052.500000
Name: mean, dtype: float64
"""


anova_Apr_Oct_do_rcp85.describe().loc['std', :]
"""
GCMs            9.967089
param           9.391762
...
#80 years:
anova_Apr_Oct_80years_AF_rcp85=annova_uncertainity(all_Apr_Oct_do_rcp85[all_Apr_Oct_do_rcp85.index>2019])


anova_Apr_Oct_80years_AF_rcp85.describe().loc['mean', :]
"""
GCMs             90.001249
param             9.401392
interaction       0.597359
GCMs/param       20.310200
year           2059.500000
Name: mean, dtype: float64
"""


anova_Apr_Oct_80years_AF_rcp85.describe().loc['std', :]

"""
GCMs           10.299805
param           9.674686
interaction     0.796844
GCMs/param     17.949115
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Apr_Oct_do_rcp85 
          

        
#all_Apr_Oct_do_rcp85= all_Apr_Oct_do_rcp85.set_index(all_Apr_Oct_do_rcp85['Datetime'])


# Apr_Oct anoxic duration  
timeseries_year_rcp85= all_Apr_Oct_do_rcp85.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Apr_Oct_do_rcp85.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp85/glue_df_Apr_Oct_hypolimnetic_ave_rcp85.csv')
...
"""        
#%% Plotting of annual DO, Apr_Oct DO summer DO of his 
...
#years
contributions_Apr_Oct_do_his_years=anova_Apr_Oct_do_his['year']
#GCMs
gcm_contributions_Apr_Oct_do_his = anova_Apr_Oct_do_his['GCMs']
#Param
param_contributions_Apr_Oct_do_his =anova_Apr_Oct_do_his['param']
#interaction
interact_contributions_Apr_Oct_do_his =anova_Apr_Oct_do_his['interaction']
...
# Subplot for rcp60
axs[1].fill_between(contributions_Apr_Oct_do_his_years, 0, gcm_contributions_Apr_Oct_do_his, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_Apr_Oct_do_his_years, gcm_contributions_Apr_Oct_do_his, gcm_contributions_Apr_Oct_do_his + param_contributions_Apr_Oct_do_his, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_Apr_Oct_do_his_years, gcm_contributions_Apr_Oct_do_his + param_contributions_Apr_Oct_do_his, gcm_contributions_Apr_Oct_do_his + param_contributions_Apr_Oct_do_his + interact_contributions_Apr_Oct_do_his, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
...
# Save the plot
plt.savefig('uncertainty_hypolimnetic_annual_Apr_Oct_DO_allyears_his.png', dpi=300, bbox_inches='tight')
...
#%%Plotting of Apr_Oct do


#%%Plot of Anova test on all_Apr_Oct_do_rcps
...
#years
contributions_Apr_Oct_do_rcp26_years=anova_Apr_Oct_do_rcp26['year']
#GCMs
gcm_contributions_Apr_Oct_do_rcp26 = anova_Apr_Oct_do_rcp26['GCMs']
#Param
param_contributions_Apr_Oct_do_rcp26 =anova_Apr_Oct_do_rcp26['param']
#interaction
interact_contributions_Apr_Oct_do_rcp26 =anova_Apr_Oct_do_rcp26['interaction']

######rcp60

#years
contributions_Apr_Oct_do_rcp60_years=anova_Apr_Oct_do_rcp60['year']
#GCMs
gcm_contributions_Apr_Oct_do_rcp60 = anova_Apr_Oct_do_rcp60['GCMs']
#Param
param_contributions_Apr_Oct_do_rcp60 =anova_Apr_Oct_do_rcp60['param']
#interaction
interact_contributions_Apr_Oct_do_rcp60 =anova_Apr_Oct_do_rcp60['interaction']
...
#years
contributions_Apr_Oct_do_rcp85_years=anova_Apr_Oct_do_rcp85['year']
#GCMs
gcm_contributions_Apr_Oct_do_rcp85 = anova_Apr_Oct_do_rcp85['GCMs']
#Param
param_contributions_Apr_Oct_do_rcp85 =anova_Apr_Oct_do_rcp85['param']
#interaction
interact_contributions_Apr_Oct_do_rcp85 =anova_Apr_Oct_do_rcp85['interaction']
...
# Subplot for rcp26
axs[0].fill_between(contributions_Apr_Oct_do_rcp26_years, 0, gcm_contributions_Apr_Oct_do_rcp26, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[0].fill_between(contributions_Apr_Oct_do_rcp26_years, gcm_contributions_Apr_Oct_do_rcp26, gcm_contributions_Apr_Oct_do_rcp26 + param_contributions_Apr_Oct_do_rcp26, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[0].fill_between(contributions_Apr_Oct_do_rcp26_years, gcm_contributions_Apr_Oct_do_rcp26 + param_contributions_Apr_Oct_do_rcp26, gcm_contributions_Apr_Oct_do_rcp26 + param_contributions_Apr_Oct_do_rcp26 + interact_contributions_Apr_Oct_do_rcp26, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[0].set_title('(a) RCP2.6', fontsize=20)
axs[0].set_ylim(0,100)
axs[0].set_xlim(2006, 2099)
axs[0].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp60
axs[1].fill_between(contributions_Apr_Oct_do_rcp60_years, 0, gcm_contributions_Apr_Oct_do_rcp60, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_Apr_Oct_do_rcp60_years, gcm_contributions_Apr_Oct_do_rcp60, gcm_contributions_Apr_Oct_do_rcp60 + param_contributions_Apr_Oct_do_rcp60, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_Apr_Oct_do_rcp60_years, gcm_contributions_Apr_Oct_do_rcp60 + param_contributions_Apr_Oct_do_rcp60, gcm_contributions_Apr_Oct_do_rcp60 + param_contributions_Apr_Oct_do_rcp60 + interact_contributions_Apr_Oct_do_rcp60, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[1].set_title('(b) RCP6.0', fontsize=20)
axs[1].set_ylim(0,100)
axs[1].set_xlim(2006, 2099)
axs[1].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp85
axs[2].fill_between(contributions_Apr_Oct_do_rcp85_years, 0, gcm_contributions_Apr_Oct_do_rcp85, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[2].fill_between(contributions_Apr_Oct_do_rcp85_years, gcm_contributions_Apr_Oct_do_rcp85, gcm_contributions_Apr_Oct_do_rcp85 + param_contributions_Apr_Oct_do_rcp85, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[2].fill_between(contributions_Apr_Oct_do_rcp85_years, gcm_contributions_Apr_Oct_do_rcp85 + param_contributions_Apr_Oct_do_rcp85, gcm_contributions_Apr_Oct_do_rcp85 + param_contributions_Apr_Oct_do_rcp85 + interact_contributions_Apr_Oct_do_rcp85, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[2].set_title('(c) RCP8.5', fontsize=20)
axs[2].set_ylim(0,100)
axs[2].set_xlim(2006, 2099)
axs[2].tick_params(axis='both', which='major', labelsize=20)
...
# Save the plot
plt.savefig('uncertainty_Apr_Oct_do_allyears_rcps.png', dpi=300, bbox_inches='tight')
...
#year
contributions_80years_Apr_Oct_do_rcp26_years=anova_Apr_Oct_do_rcp26[anova_Apr_Oct_do_rcp26.year>2019].year
#gcms
gcm_contributions_80years_Apr_Oct_do_rcp26 = anova_Apr_Oct_do_rcp26[anova_Apr_Oct_do_rcp26.year>2019]['GCMs']
#param
param_contributions_80years_Apr_Oct_do_rcp26 =anova_Apr_Oct_do_rcp26[anova_Apr_Oct_do_rcp26.year>2019]['param']
#interaction
interact_contributions_80years_Apr_Oct_do_rcp26 =anova_Apr_Oct_do_rcp26[anova_Apr_Oct_do_rcp26.year>2019]['interaction']
...
#year
contributions_80years_Apr_Oct_do_rcp60_years=anova_Apr_Oct_do_rcp60[anova_Apr_Oct_do_rcp60.year>2019].year
#gcms
gcm_contributions_80years_Apr_Oct_do_rcp60 = anova_Apr_Oct_do_rcp60[anova_Apr_Oct_do_rcp60.year>2019]['GCMs']
#param
param_contributions_80years_Apr_Oct_do_rcp60 =anova_Apr_Oct_do_rcp60[anova_Apr_Oct_do_rcp60.year>2019]['param']
#interaction
interact_contributions_80years_Apr_Oct_do_rcp60 =anova_Apr_Oct_do_rcp60[anova_Apr_Oct_do_rcp60.year>2019]['interaction']


##########rcp85
#year
contributions_80years_Apr_Oct_do_rcp85_years=anova_Apr_Oct_do_rcp85[anova_Apr_Oct_do_rcp85.year>2019].year
#gcms
gcm_contributions_80years_Apr_Oct_do_rcp85 = anova_Apr_Oct_do_rcp85[anova_Apr_Oct_do_rcp85.year>2019]['GCMs']
#param
param_contributions_80years_Apr_Oct_do_rcp85 =anova_Apr_Oct_do_rcp85[anova_Apr_Oct_do_rcp85.year>2019]['param']
#interaction
interact_contributions_80years_Apr_Oct_do_rcp85 =anova_Apr_Oct_do_rcp85[anova_Apr_Oct_do_rcp85.year>2019]['interaction']
...
# Subplot for rcp26
axs[0].fill_between(contributions_80years_Apr_Oct_do_rcp26_years, 0, gcm_contributions_80years_Apr_Oct_do_rcp26, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[0].fill_between(contributions_80years_Apr_Oct_do_rcp26_years, gcm_contributions_80years_Apr_Oct_do_rcp26, gcm_contributions_80years_Apr_Oct_do_rcp26 + param_contributions_80years_Apr_Oct_do_rcp26, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[0].fill_between(contributions_80years_Apr_Oct_do_rcp26_years, gcm_contributions_80years_Apr_Oct_do_rcp26 + param_contributions_80years_Apr_Oct_do_rcp26, gcm_contributions_80years_Apr_Oct_do_rcp26 + param_contributions_80years_Apr_Oct_do_rcp26 + interact_contributions_80years_Apr_Oct_do_rcp26, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[0].set_title('(a) RCP2.6', fontsize=20)
axs[0].set_ylim(0,100)
axs[0].set_xlim(2020, 2099)
axs[0].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp60
axs[1].fill_between(contributions_80years_Apr_Oct_do_rcp60_years, 0, gcm_contributions_80years_Apr_Oct_do_rcp60, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_80years_Apr_Oct_do_rcp60_years, gcm_contributions_80years_Apr_Oct_do_rcp60, gcm_contributions_80years_Apr_Oct_do_rcp60 + param_contributions_80years_Apr_Oct_do_rcp60, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_80years_Apr_Oct_do_rcp60_years, gcm_contributions_80years_Apr_Oct_do_rcp60 + param_contributions_80years_Apr_Oct_do_rcp60, gcm_contributions_80years_Apr_Oct_do_rcp60 + param_contributions_80years_Apr_Oct_do_rcp60 + interact_contributions_80years_Apr_Oct_do_rcp60, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[1].set_title('(b) RCP6.0', fontsize=20)
axs[1].set_ylim(0,100)
axs[1].set_xlim(2020, 2099)
axs[1].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp85
axs[2].fill_between(contributions_80years_Apr_Oct_do_rcp85_years, 0, gcm_contributions_80years_Apr_Oct_do_rcp85, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[2].fill_between(contributions_80years_Apr_Oct_do_rcp85_years, gcm_contributions_80years_Apr_Oct_do_rcp85, gcm_contributions_80years_Apr_Oct_do_rcp85 + param_contributions_80years_Apr_Oct_do_rcp85, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[2].fill_between(contributions_80years_Apr_Oct_do_rcp85_years, gcm_contributions_80years_Apr_Oct_do_rcp85 + param_contributions_80years_Apr_Oct_do_rcp85, gcm_contributions_80years_Apr_Oct_do_rcp85 + param_contributions_80years_Apr_Oct_do_rcp85 + interact_contributions_80years_Apr_Oct_do_rcp85, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[2].set_title('(c) RCP8.5', fontsize=20)
axs[2].set_ylim(0,100)
axs[2].set_xlim(2020, 2099)
axs[2].tick_params(axis='both', which='major', labelsize=20)
...
# Save the plot
plt.savefig('uncertainty_Apr_Oct_do_80years_rcps.png', dpi=300, bbox_inches='tight')
...
ax=plt.fill_between(glue_df_Apr_Oct_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Apr_Oct_hypolimnetic_ave_rcp60['5%'], glue_df_Apr_Oct_hypolimnetic_ave_rcp60['95%'], color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
...
#%%
np.mean(glue_df_Apr_Oct_hypolimnetic_ave_his['50%'])# 7.66120828881849
np.mean(glue_df_Apr_Oct_hypolimnetic_ave_rcp26['50%'])#6.618663963770041
np.mean(glue_df_Apr_Oct_hypolimnetic_ave_rcp60['50%'])#6.320917663879071
np.mean(glue_df_Apr_Oct_hypolimnetic_ave_rcp85['50%'])# 6.046266677458798
...
#%%plotting Apr_Oct anoxic factor over 80 years 
...
fig.savefig("GLUE_Timeseries_80years_Apr_Oct_hypolimnetic_ave.png",  dpi=300, bbox_inches='tight')
...
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(1.1, -0.2), fontsize=22, ncol=4)  
fig.savefig("GLUE_Timeseries_Apr_Oct_hypolimnetic_ave_anormaly.png",  dpi=300, bbox_inches='tight')
...
all_Apr_Oct_do_rcp26_test= pd.DataFrame([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("DO_prof_gfdl_rcp26"):
        ...
        result_Apr_Oct =Apr_Oct_hypolimnetic_ave (C, Vr, time_series )
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp26"):
        ...
        all_Apr_Oct_do_rcp26_test= pd.concat([all_Apr_Oct_do_rcp26_test , result_Apr_Oct], axis=1)
        ...
        # Save the result Apr_Oct to a new CSV file
        result_Apr_Oct_filename = f'Apr_Oct_do_gfdl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
        
        header_df = pd.DataFrame([header_values])
        header_df.to_csv(os.path.join(directory, result_Apr_Oct_filename))#, index=False)
       

        result_Apr_Oct.to_csv(os.path.join(directory, result_Apr_Oct_filename) , mode='a' , index_label='year', na_rep='NaN', header=['Apr_Oct_AF'])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp26"):
        ...
        # Save the result Apr_Oct to a new CSV file
        result_Apr_Oct_filename = f'Apr_Oct_do_hadgem_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp26"):
        ...
        # Save the result Apr_Oct to a new CSV file
        result_Apr_Oct_filename = f'Apr_Oct_do_ipsl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp26"):
        ...
        # Save the result Apr_Oct to a new CSV file
        result_Apr_Oct_filename = f'Apr_Oct_do_miroc_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%% GLUE of diff of test rcp26 scenarios for annual/Apr_Oct/summer do


all_annual_do_rcp26_test
all_Apr_Oct_do_rcp26_test
#all_summer_do_rcp26_test

all_annual_do_rcp26
all_Apr_Oct_do_rcp26
#all_summer_do_rcp26


diff_base_test_annual_do_rcp26= pd.DataFrame(np.array(all_annual_do_rcp26)-np.array(all_annual_do_rcp26_test))

diff_base_test_Apr_Oct_do_rcp26= pd.DataFrame(np.array(all_Apr_Oct_do_rcp26)-np.array(all_Apr_Oct_do_rcp26_test))
...
# Apr_Oct DO hypolimnion 
timeseries_year_rcp26= all_Apr_Oct_do_rcp26_test.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in diff_base_test_Apr_Oct_do_rcp26.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_diff_base_test_Apr_Oct_do_rcp26 = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_diff_base_test_Apr_Oct_do_rcp26=glue_diff_base_test_Apr_Oct_do_rcp26.set_index(timeseries_year_rcp26)    
glue_diff_base_test_Apr_Oct_do_rcp26=glue_diff_base_test_Apr_Oct_do_rcp26.sort_index()
glue_diff_base_test_Apr_Oct_do_rcp26_80years=glue_diff_base_test_Apr_Oct_do_rcp26[glue_diff_base_test_Apr_Oct_do_rcp26.index>2019]
"""
...
quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Apr_Oct_do_rcp26_test.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_Apr_Oct_do_rcp26_test = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_Apr_Oct_do_rcp26_test=glue_Apr_Oct_do_rcp26_test.set_index(timeseries_year_rcp26)    
glue_Apr_Oct_do_rcp26_test=glue_Apr_Oct_do_rcp26_test.sort_index()
glue_Apr_Oct_do_rcp26_test_80years=glue_Apr_Oct_do_rcp26_test[glue_Apr_Oct_do_rcp26_test.index>2019]
...
glue_diff_base_test_Apr_Oct_do_rcp26_80years=glue_diff_base_test_Apr_Oct_do_rcp26[glue_diff_base_test_Apr_Oct_do_rcp26.index>2019]
autocorr_MK_org_modif_sens_slope_test(glue_diff_base_test_Apr_Oct_do_rcp26_80years['50%'])
...
autocorr_MK_org_modif_sens_slope_test(glue_Apr_Oct_do_rcp26_test_80years['50%'])
(0.00890653300478083,
 'positively autocorrelated',
 'decreasing',
...
ax = axs[1]
ax.fill_between(glue_diff_base_test_Apr_Oct_do_rcp26_80years.index,
                glue_diff_base_test_Apr_Oct_do_rcp26_80years['5%'],
                glue_diff_base_test_Apr_Oct_do_rcp26_80years['95%'],
                color='green', alpha=0.2, label='90% CI')
ax.plot(glue_diff_base_test_Apr_Oct_do_rcp26_80years.index,
        glue_diff_base_test_Apr_Oct_do_rcp26_80years['50%'],
        'green', label='Median', alpha=0.9, linewidth=3)

# Add trendline
trendline_rcp26_1 = autocorr_MK_org_modif_sens_slope_test(glue_diff_base_test_Apr_Oct_do_rcp26_80years['50%'])
...
ax.plot(glue_diff_base_test_Apr_Oct_do_rcp26_80years.index.astype(float),
...
ax.set_xticks(glue_diff_base_test_Apr_Oct_do_rcp26_80years.index)
ax.set_xticklabels(glue_diff_base_test_Apr_Oct_do_rcp26_80years.index, rotation=45, fontsize=22)
ax.xaxis.set_major_locator(MaxNLocator(prune='both'))

# Plot for the second subplot
ax = axs[0]
ax.fill_between(glue_Apr_Oct_do_rcp26_test_80years.index,
                glue_Apr_Oct_do_rcp26_test_80years['5%'],
                glue_Apr_Oct_do_rcp26_test_80years['95%'],
                color='green', alpha=0.2)#, label='90% CI')
ax.plot(glue_Apr_Oct_do_rcp26_test_80years.index,
        glue_Apr_Oct_do_rcp26_test_80years['50%'].astype(float),
        'green', alpha=0.9, linewidth=3)# label='Median',

# Add trendline
trendline_rcp26_0 = autocorr_MK_org_modif_sens_slope_test(glue_Apr_Oct_do_rcp26_test_80years['50%'])
...
ax.set_xlabel('Year', fontsize=26)
ax.tick_params(axis='y', labelsize=22)
ax.set_xticks(glue_Apr_Oct_do_rcp26_test_80years.index)
ax.set_xticklabels(glue_Apr_Oct_do_rcp26_test_80years.index, rotation=45, fontsize=22)
ax.xaxis.set_major_locator(MaxNLocator(prune='both'))
...
plt.savefig("atttest_difference_test_initalcondition_fixed_Apr_Oct_do_80years_rcp26.png",  dpi=300, bbox_inches='tight')




#%%
glue_diff_base_test_Apr_Oct_do_rcp26_80years
glue_Apr_Oct_do_rcp26_test_80years
...
ax=plt.fill_between(glue_Apr_Oct_do_rcp26_test_80years.index.astype(float), glue_Apr_Oct_do_rcp26_test_80years['5%'], glue_Apr_Oct_do_rcp26_test_80years['95%'], color='green', alpha=0.2 ,  label= '90% CI')
ax=plt.plot(glue_Apr_Oct_do_rcp26_test_80years.index.astype(float), glue_Apr_Oct_do_rcp26_test_80years['50%'].astype(float), 'green', label='Median', alpha=0.9, linewidth=3  )




trendline_rcp26=autocorr_MK_org_modif_sens_slope_test(glue_Apr_Oct_do_rcp26_test_80years['50%'])
ax=plt.text(2020, 2, f'y = {trendline_rcp26[-2]:.3f}x + {trendline_rcp26[-1]:.3f}, p = {trendline_rcp26[-3]:.3f}', color='green', fontsize= 20 )

ax=plt.plot(glue_Apr_Oct_do_rcp26_test_80years.index.astype(float),
        trendline_rcp26[-2] * np.arange(80) + trendline_rcp26[-1],
        linestyle='--', color='green', alpha=0.9, linewidth=3)
...
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)#)   
fig.savefig("test_initalcondition_fixed_Apr_Oct_do_80years_rcp26.png",  dpi=300, bbox_inches='tight')
...
#%% Apr_Oct anoxic factor_gfdl_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/gfdl_senarios/his'
...
#%% Apr_Oct anoxic factor_gfdl_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/gfdl_senarios/rcp26'
...
#%% Apr_Oct anoxic factor_gfdl_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/gfdl_senarios/rcp60'
...
#%% Apr_Oct anoxic factor_gfdl_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/gfdl_senarios/rcp85'
...
#%% Apr_Oct anoxic factor_hadgem_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/hadgem_senarios/his'
...
#%% Apr_Oct anoxic factor_hadgem_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/hadgem_senarios/rcp26'
...
#%% Apr_Oct anoxic factor_hadgem_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/hadgem_senarios/rcp60'
...
#%% Apr_Oct anoxic factor_hadgem_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/hadgem_senarios/rcp85'
...
#%% Apr_Oct anoxic factor_ipsl_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/ipsl_senarios/his'
...
#%% Apr_Oct anoxic factor_ipsl_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/ipsl_senarios/rcp26'
...
#%% Apr_Oct anoxic factor_ipsl_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/ipsl_senarios/rcp60'
...
#%% Apr_Oct anoxic factor_ipsl_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/ipsl_senarios/rcp85'
...
#%% Apr_Oct anoxic factor_miroc_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/miroc_senarios/his'
...
#%% Apr_Oct anoxic factor_miroc_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/miroc_senarios/rcp26'
...
#%% Apr_Oct anoxic factor_miroc_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/miroc_senarios/rcp60'
...
#%% Apr_Oct anoxic factor_miroc_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/miroc_senarios/rcp85'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Apr_Oct_hypolimnetic_ave_gfdl_his"):
        ...
        # Read the DataFrame below the header
        Apr_Oct_hypolimnetic_ave = pd.read_csv(os.path.join(directory, filename), skiprows=2)
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/his/glue_df_anoxic_factor_his.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp26/glue_df_anoxic_factor_rcp26.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp60/glue_df_anoxic_factor_rcp60.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Apr_Oct_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/PhD_py_code/Future_simulation_results/all_4_models/rcp85/glue_df_anoxic_factor_rcp85.csv')
...
ax=plt.fill_between(glue_80years_Apr_Oct_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Apr_Oct_hypolimnetic_ave_rcp60['5%'], glue_80years_Apr_Oct_hypolimnetic_ave_rcp60['95%'], color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_80years_Apr_Oct_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Apr_Oct_hypolimnetic_ave_rcp60['50%'], 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )
trendline_rcp60=autocorr_MK_org_modif_sens_slope_test(glue_80years_Apr_Oct_hypolimnetic_ave_rcp60['50%'])
...
ax=plt.ylabel('anoxic factor in Apr_Oct [d/year]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)#)   
...
ax=plt.fill_between(glue_df_Apr_Oct_hypolimnetic_ave_his[(1960 < glue_df_Apr_Oct_hypolimnetic_ave_his.index)].index.astype(float),
                      glue_df_Apr_Oct_hypolimnetic_ave_his[(1960 < glue_df_Apr_Oct_hypolimnetic_ave_his.index)]['5%'] - Apr_Oct_hypolimnetic_ave_ref,
                      glue_df_Apr_Oct_hypolimnetic_ave_his[(1960 < glue_df_Apr_Oct_hypolimnetic_ave_his.index) ]['95%'] - Apr_Oct_hypolimnetic_ave_ref,
                      color='grey', alpha=0.2, label='His 90% CI')


ax=plt.plot(glue_df_Apr_Oct_hypolimnetic_ave_his[(1960 < glue_df_Apr_Oct_hypolimnetic_ave_his.index) ].index.astype(float),
            glue_df_Apr_Oct_hypolimnetic_ave_his[(1960 < glue_df_Apr_Oct_hypolimnetic_ave_his.index)]['50%'] - Apr_Oct_hypolimnetic_ave_ref,
            'k', label='His median', alpha=0.9, linewidth=3   )
...
ax=plt.fill_between(glue_df_Apr_Oct_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Apr_Oct_hypolimnetic_ave_rcp60['5%']-Apr_Oct_hypolimnetic_ave_ref, glue_df_Apr_Oct_hypolimnetic_ave_rcp60['95%']-Apr_Oct_hypolimnetic_ave_ref, color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_df_Apr_Oct_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Apr_Oct_hypolimnetic_ave_rcp60['50%']-Apr_Oct_hypolimnetic_ave_ref, 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )
