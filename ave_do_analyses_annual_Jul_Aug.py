...
glue_df_annual_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_annual_hypolimnetic_ave_his.csv')
...
#%% Jul_Aug hypolimnetic_ave_his

all_Jul_Aug_do_his=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_his_Jv_"):
        ...
        # Apply the Jul_Aug_hypolimnetic_ave function
        result = Jul_Aug_hypolimnetic_ave(C, Vr, time_series )

        all_Jul_Aug_do_his = pd.concat([all_Jul_Aug_do_his , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_gfdl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
        
        header_df = pd.DataFrame([header_values])
        header_df.to_csv(os.path.join(directory, result_filename))#, index=False)
       

        result.to_csv(os.path.join(directory, result_filename) , mode='a' , index_label='year', na_rep='NaN', header=['Jul_Aug_hypolimnetic_ave'])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_hadgem_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_ipsl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_his_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_miroc_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Jul_Aug_do_his

anova_Jul_Aug_do_his=annova_uncertainity(all_Jul_Aug_do_his)

anova_Jul_Aug_do_his.describe().loc['mean', :]
"""
GCMs             76.214728
param            21.679602
interaction       2.105670
GCMs/param       12.987055
year           1933.000000
Name: mean, dtype: float64
"""


anova_Jul_Aug_do_his.describe().loc['std', :]
"""
GCMs           20.950261
param          19.746401
interaction     2.285249
GCMs/param     32.675970
year           42.001984
Name: std, dtype: float64
"""
...
#%% GLUE method on all_Jul_Aug_do_his 
          

        
#all_Jul_Aug_do_his= all_Jul_Aug_do_his.set_index(all_Jul_Aug_do_his['Datetime'])


# Jul_Aug anoxic duration  
timeseries_year_his= all_Jul_Aug_do_his.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_do_his.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_df_Jul_Aug_hypolimnetic_ave_his = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_df_Jul_Aug_hypolimnetic_ave_his=glue_df_Jul_Aug_hypolimnetic_ave_his.set_index(timeseries_year_his)    


# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_Jul_Aug_hypolimnetic_ave_his.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_df_summer_hypolimnetic_ave_his.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_annual_hypolimnetic_ave_rcp26.csv')
        

#%% Jul_Aug hypolimnetic_ave_rcp26

all_Jul_Aug_do_rcp26=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp26_Jv_"):
        ...
        all_Jul_Aug_do_rcp26 = pd.concat([all_Jul_Aug_do_rcp26 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_gfdl_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_hadgem_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_ipsl_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp26_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_miroc_rcp26_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Jul_Aug_do_rcp26

anova_Jul_Aug_do_rcp26=annova_uncertainity(all_Jul_Aug_do_rcp26)

anova_Jul_Aug_do_rcp26.describe().loc['mean', :]
"""
GCMs             67.478696
param            28.249684
interaction       4.271620
GCMs/param        4.978468
year           2052.500000
Name: mean, dtype: float64
"""
...
anova_Jul_Aug_do_rcp26.describe().loc['std', :]
"""
GCMs           20.015818
param          19.637837
interaction     2.855859
GCMs/param      6.204726
year           27.279418
Name: std, dtype: float64
"""
...
#80 years:
anova_Jul_Aug_80years_AF_rcp26=annova_uncertainity(all_Jul_Aug_do_rcp26[all_Jul_Aug_do_rcp26.index>2019])


anova_Jul_Aug_80years_AF_rcp26.describe().loc['mean', :]
"""
GCMs             67.641154
param            27.835253
interaction       4.523593
GCMs/param        5.077863
year           2059.500000
Name: mean, dtype: float64
"""
...
anova_Jul_Aug_80years_AF_rcp26.describe().loc['std', :]

"""
GCMs           19.405391
param          18.952588
interaction     2.917194
GCMs/param      6.542503
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Jul_Aug_do_rcp26 
          

        
#all_Jul_Aug_do_rcp26= all_Jul_Aug_do_rcp26.set_index(all_Jul_Aug_do_rcp26['Datetime'])


# Jul_Aug anoxic duration  
timeseries_year_rcp26= all_Jul_Aug_do_rcp26.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_do_rcp26.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_df_Jul_Aug_hypolimnetic_ave_rcp26 = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_df_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26.set_index(timeseries_year_rcp26)    


# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_Jul_Aug_hypolimnetic_ave_rcp26.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_summer_hypolimnetic_ave_rcp26.csv')
"""        
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_annual_hypolimnetic_ave_rcp60.csv')
        

#%% Jul_Aug hypolimnetic_ave_rcp60

all_Jul_Aug_do_rcp60=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp60_Jv_"):
        ...
        all_Jul_Aug_do_rcp60 = pd.concat([all_Jul_Aug_do_rcp60 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_gfdl_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_hadgem_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_ipsl_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp60_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_miroc_rcp60_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Jul_Aug_do_rcp60

anova_Jul_Aug_do_rcp60=annova_uncertainity(all_Jul_Aug_do_rcp60)

anova_Jul_Aug_do_rcp60.describe().loc['mean', :]
"""
GCMs             68.404018
param            26.045521
interaction       5.550461
GCMs/param       11.548660
year           2052.500000
Name: mean, dtype: float64
"""


anova_Jul_Aug_do_rcp60.describe().loc['std', :]
"""
GCMs           24.373769
param          21.935307
interaction     5.537028
GCMs/param     23.803599
year           27.279418
Name: std, dtype: float64
"""
#80 years:
anova_Jul_Aug_80years_AF_rcp60=annova_uncertainity(all_Jul_Aug_do_rcp60[all_Jul_Aug_do_rcp60.index>2019])


anova_Jul_Aug_80years_AF_rcp60.describe().loc['mean', :]
"""
GCMs             67.247917
param            26.785459
interaction       5.966624
GCMs/param       10.346450
year           2059.500000
Name: mean, dtype: float64
"""


anova_Jul_Aug_80years_AF_rcp60.describe().loc['std', :]

"""
GCMs           24.929707
param          22.478339
interaction     5.783252
GCMs/param     19.730447
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Jul_Aug_do_rcp60 
          

        
#all_Jul_Aug_do_rcp60= all_Jul_Aug_do_rcp60.set_index(all_Jul_Aug_do_rcp60['Datetime'])


# Jul_Aug anoxic duration  
timeseries_year_rcp60= all_Jul_Aug_do_rcp60.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_do_rcp60.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_df_Jul_Aug_hypolimnetic_ave_rcp60 = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_df_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60.set_index(timeseries_year_rcp60)    


# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_Jul_Aug_hypolimnetic_ave_rcp60.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_summer_hypolimnetic_ave_rcp60.csv')
"""        
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_annual_hypolimnetic_ave_rcp85.csv')
        

#%% Jul_Aug hypolimnetic_ave_rcp85

all_Jul_Aug_do_rcp85=pd.DataFrame([])
all_weights= np.array([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp85_Jv_"):
        ...
        all_Jul_Aug_do_rcp85 = pd.concat([all_Jul_Aug_do_rcp85 , result], axis=1)
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_gfdl_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_hadgem_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_ipsl_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp85_Jv_"):
        ...
        # Save the result to a new CSV file
        result_filename = f'Jul_Aug_hypolimnetic_ave_miroc_rcp85_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%%Uncertainity partitioning on all_Jul_Aug_do_rcp85

anova_Jul_Aug_do_rcp85=annova_uncertainity(all_Jul_Aug_do_rcp85)

anova_Jul_Aug_do_rcp85.describe().loc['mean', :]
"""
GCMs             79.830411
param            15.195055
interaction       4.974534
GCMs/param       33.889309
year           2052.500000
Name: mean, dtype: float64
"""


anova_Jul_Aug_do_rcp85.describe().loc['std', :]
"""
GCMs           20.562696
param          16.401698
interaction     6.496272
GCMs/param     92.540340
year           27.279418
Name: std, dtype: float64
"""

#80 years:
anova_Jul_Aug_80years_AF_rcp85=annova_uncertainity(all_Jul_Aug_do_rcp85[all_Jul_Aug_do_rcp85.index>2019])


anova_Jul_Aug_80years_AF_rcp85.describe().loc['mean', :]
"""
GCMs             79.988074
param            14.691465
interaction       5.320461
GCMs/param       38.112963
year           2059.500000
Name: mean, dtype: float64
"""


anova_Jul_Aug_80years_AF_rcp85.describe().loc['std', :]

"""
GCMs           21.114827
param          16.588153
interaction     6.870281
GCMs/param     99.726692
year           23.237900
Name: std, dtype: float64
...
#%% GLUE method on all_Jul_Aug_do_rcp85 
          

        
#all_Jul_Aug_do_rcp85= all_Jul_Aug_do_rcp85.set_index(all_Jul_Aug_do_rcp85['Datetime'])


# Jul_Aug anoxic duration  
timeseries_year_rcp85= all_Jul_Aug_do_rcp85.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_do_rcp85.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_df_Jul_Aug_hypolimnetic_ave_rcp85 = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_df_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85.set_index(timeseries_year_rcp85)    


# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_Jul_Aug_hypolimnetic_ave_rcp85.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_summer_hypolimnetic_ave_rcp85.csv')
"""        
#%% Plotting of annual DO, Jul_Aug DO summer DO of his 
...
#years
contributions_Jul_Aug_do_his_years=anova_Jul_Aug_do_his['year']
#GCMs
gcm_contributions_Jul_Aug_do_his = anova_Jul_Aug_do_his['GCMs']
#Param
param_contributions_Jul_Aug_do_his =anova_Jul_Aug_do_his['param']
#interaction
interact_contributions_Jul_Aug_do_his =anova_Jul_Aug_do_his['interaction']
...
# Subplot for his
axs[1].fill_between(contributions_Jul_Aug_do_his_years, 0, gcm_contributions_Jul_Aug_do_his, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_Jul_Aug_do_his_years, gcm_contributions_Jul_Aug_do_his, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_Jul_Aug_do_his_years, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his + interact_contributions_Jul_Aug_do_his, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[1].set_title('(b) Jul-Aug DO', fontsize=20)
...
# Save the plot
plt.savefig('uncertainty_hypolimnetic_annual_Jul_Aug_DO_allyears_his.png', dpi=300, bbox_inches='tight')
...
axs[0, 0].fill_between(contributions_Jul_Aug_do_his_years, 0, gcm_contributions_Jul_Aug_do_his, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[0, 0].fill_between(contributions_Jul_Aug_do_his_years, gcm_contributions_Jul_Aug_do_his, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[0, 0].fill_between(contributions_Jul_Aug_do_his_years, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his, gcm_contributions_Jul_Aug_do_his + param_contributions_Jul_Aug_do_his + interact_contributions_Jul_Aug_do_his, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
...
# Adding labels and title with increased font size
# fig.text(0.5, 0.08, 'Year', ha='center', fontsize=20)
fig.text(0.08, 0.5, 'Uncertainty sources in average deep-water DO in Jul-Aug [%]', va='center', rotation='vertical', fontsize=24)
...
# Save the plot
plt.savefig('uncertainty_annualDO_allyears_rcps_and_his.png', dpi=300, bbox_inches='tight')
...
#%%Plotting of Jul_Aug do


#%%Plot of Anova test on all_Jul_Aug_do_rcps
...
#years
contributions_Jul_Aug_do_rcp26_years=anova_Jul_Aug_do_rcp26['year']
#GCMs
gcm_contributions_Jul_Aug_do_rcp26 = anova_Jul_Aug_do_rcp26['GCMs']
#Param
param_contributions_Jul_Aug_do_rcp26 =anova_Jul_Aug_do_rcp26['param']
#interaction
interact_contributions_Jul_Aug_do_rcp26 =anova_Jul_Aug_do_rcp26['interaction']

######rcp60

#years
contributions_Jul_Aug_do_rcp60_years=anova_Jul_Aug_do_rcp60['year']
#GCMs
gcm_contributions_Jul_Aug_do_rcp60 = anova_Jul_Aug_do_rcp60['GCMs']
#Param
param_contributions_Jul_Aug_do_rcp60 =anova_Jul_Aug_do_rcp60['param']
#interaction
interact_contributions_Jul_Aug_do_rcp60 =anova_Jul_Aug_do_rcp60['interaction']
...
#years
contributions_Jul_Aug_do_rcp85_years=anova_Jul_Aug_do_rcp85['year']
#GCMs
gcm_contributions_Jul_Aug_do_rcp85 = anova_Jul_Aug_do_rcp85['GCMs']
#Param
param_contributions_Jul_Aug_do_rcp85 =anova_Jul_Aug_do_rcp85['param']
#interaction
interact_contributions_Jul_Aug_do_rcp85 =anova_Jul_Aug_do_rcp85['interaction']
...
# Subplot for rcp26
axs[0].fill_between(contributions_Jul_Aug_do_rcp26_years, 0, gcm_contributions_Jul_Aug_do_rcp26, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[0].fill_between(contributions_Jul_Aug_do_rcp26_years, gcm_contributions_Jul_Aug_do_rcp26, gcm_contributions_Jul_Aug_do_rcp26 + param_contributions_Jul_Aug_do_rcp26, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[0].fill_between(contributions_Jul_Aug_do_rcp26_years, gcm_contributions_Jul_Aug_do_rcp26 + param_contributions_Jul_Aug_do_rcp26, gcm_contributions_Jul_Aug_do_rcp26 + param_contributions_Jul_Aug_do_rcp26 + interact_contributions_Jul_Aug_do_rcp26, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[0].set_title('(a) RCP2.6', fontsize=20)
axs[0].set_ylim(0,100)
axs[0].set_xlim(2006, 2099)
axs[0].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp60
axs[1].fill_between(contributions_Jul_Aug_do_rcp60_years, 0, gcm_contributions_Jul_Aug_do_rcp60, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_Jul_Aug_do_rcp60_years, gcm_contributions_Jul_Aug_do_rcp60, gcm_contributions_Jul_Aug_do_rcp60 + param_contributions_Jul_Aug_do_rcp60, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_Jul_Aug_do_rcp60_years, gcm_contributions_Jul_Aug_do_rcp60 + param_contributions_Jul_Aug_do_rcp60, gcm_contributions_Jul_Aug_do_rcp60 + param_contributions_Jul_Aug_do_rcp60 + interact_contributions_Jul_Aug_do_rcp60, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[1].set_title('(b) RCP6.0', fontsize=20)
axs[1].set_ylim(0,100)
axs[1].set_xlim(2006, 2099)
axs[1].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp85
axs[2].fill_between(contributions_Jul_Aug_do_rcp85_years, 0, gcm_contributions_Jul_Aug_do_rcp85, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[2].fill_between(contributions_Jul_Aug_do_rcp85_years, gcm_contributions_Jul_Aug_do_rcp85, gcm_contributions_Jul_Aug_do_rcp85 + param_contributions_Jul_Aug_do_rcp85, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[2].fill_between(contributions_Jul_Aug_do_rcp85_years, gcm_contributions_Jul_Aug_do_rcp85 + param_contributions_Jul_Aug_do_rcp85, gcm_contributions_Jul_Aug_do_rcp85 + param_contributions_Jul_Aug_do_rcp85 + interact_contributions_Jul_Aug_do_rcp85, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[2].set_title('(c) RCP8.5', fontsize=20)
axs[2].set_ylim(0,100)
axs[2].set_xlim(2006, 2099)
axs[2].tick_params(axis='both', which='major', labelsize=20)
...
# Adding labels and title with increased font size
# fig.text(0.5, 0.08, 'Year', ha='center', fontsize=20)
fig.text(0.07, 0.5, 'Uncertainty sources in \n Jul-Aug deep-water DO [%]', va='center', rotation='vertical', fontsize=22)
...
# Save the plot
plt.savefig('uncertainty_Jul_Aug_do_allyears_rcps.png', dpi=300, bbox_inches='tight')
...
#year
contributions_80years_Jul_Aug_do_rcp26_years=anova_Jul_Aug_do_rcp26[anova_Jul_Aug_do_rcp26.year>2019].year
#gcms
gcm_contributions_80years_Jul_Aug_do_rcp26 = anova_Jul_Aug_do_rcp26[anova_Jul_Aug_do_rcp26.year>2019]['GCMs']
#param
param_contributions_80years_Jul_Aug_do_rcp26 =anova_Jul_Aug_do_rcp26[anova_Jul_Aug_do_rcp26.year>2019]['param']
#interaction
interact_contributions_80years_Jul_Aug_do_rcp26 =anova_Jul_Aug_do_rcp26[anova_Jul_Aug_do_rcp26.year>2019]['interaction']
...
#year
contributions_80years_Jul_Aug_do_rcp60_years=anova_Jul_Aug_do_rcp60[anova_Jul_Aug_do_rcp60.year>2019].year
#gcms
gcm_contributions_80years_Jul_Aug_do_rcp60 = anova_Jul_Aug_do_rcp60[anova_Jul_Aug_do_rcp60.year>2019]['GCMs']
#param
param_contributions_80years_Jul_Aug_do_rcp60 =anova_Jul_Aug_do_rcp60[anova_Jul_Aug_do_rcp60.year>2019]['param']
#interaction
interact_contributions_80years_Jul_Aug_do_rcp60 =anova_Jul_Aug_do_rcp60[anova_Jul_Aug_do_rcp60.year>2019]['interaction']


##########rcp85
#year
contributions_80years_Jul_Aug_do_rcp85_years=anova_Jul_Aug_do_rcp85[anova_Jul_Aug_do_rcp85.year>2019].year
#gcms
gcm_contributions_80years_Jul_Aug_do_rcp85 = anova_Jul_Aug_do_rcp85[anova_Jul_Aug_do_rcp85.year>2019]['GCMs']
#param
param_contributions_80years_Jul_Aug_do_rcp85 =anova_Jul_Aug_do_rcp85[anova_Jul_Aug_do_rcp85.year>2019]['param']
#interaction
interact_contributions_80years_Jul_Aug_do_rcp85 =anova_Jul_Aug_do_rcp85[anova_Jul_Aug_do_rcp85.year>2019]['interaction']
...
# Subplot for rcp26
axs[0].fill_between(contributions_80years_Jul_Aug_do_rcp26_years, 0, gcm_contributions_80years_Jul_Aug_do_rcp26, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[0].fill_between(contributions_80years_Jul_Aug_do_rcp26_years, gcm_contributions_80years_Jul_Aug_do_rcp26, gcm_contributions_80years_Jul_Aug_do_rcp26 + param_contributions_80years_Jul_Aug_do_rcp26, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[0].fill_between(contributions_80years_Jul_Aug_do_rcp26_years, gcm_contributions_80years_Jul_Aug_do_rcp26 + param_contributions_80years_Jul_Aug_do_rcp26, gcm_contributions_80years_Jul_Aug_do_rcp26 + param_contributions_80years_Jul_Aug_do_rcp26 + interact_contributions_80years_Jul_Aug_do_rcp26, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[0].set_title('(a) RCP2.6', fontsize=20)
axs[0].set_ylim(0,100)
axs[0].set_xlim(2020, 2099)
axs[0].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp60
axs[1].fill_between(contributions_80years_Jul_Aug_do_rcp60_years, 0, gcm_contributions_80years_Jul_Aug_do_rcp60, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[1].fill_between(contributions_80years_Jul_Aug_do_rcp60_years, gcm_contributions_80years_Jul_Aug_do_rcp60, gcm_contributions_80years_Jul_Aug_do_rcp60 + param_contributions_80years_Jul_Aug_do_rcp60, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[1].fill_between(contributions_80years_Jul_Aug_do_rcp60_years, gcm_contributions_80years_Jul_Aug_do_rcp60 + param_contributions_80years_Jul_Aug_do_rcp60, gcm_contributions_80years_Jul_Aug_do_rcp60 + param_contributions_80years_Jul_Aug_do_rcp60 + interact_contributions_80years_Jul_Aug_do_rcp60, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[1].set_title('(b) RCP6.0', fontsize=20)
axs[1].set_ylim(0,100)
axs[1].set_xlim(2020, 2099)
axs[1].tick_params(axis='both', which='major', labelsize=20)
...
# Subplot for rcp85
axs[2].fill_between(contributions_80years_Jul_Aug_do_rcp85_years, 0, gcm_contributions_80years_Jul_Aug_do_rcp85, label='GCMs', alpha=0.7, color=colors[0], edgecolor='black')
axs[2].fill_between(contributions_80years_Jul_Aug_do_rcp85_years, gcm_contributions_80years_Jul_Aug_do_rcp85, gcm_contributions_80years_Jul_Aug_do_rcp85 + param_contributions_80years_Jul_Aug_do_rcp85, label='Parameters', alpha=0.7, color=colors[1], edgecolor='black')
axs[2].fill_between(contributions_80years_Jul_Aug_do_rcp85_years, gcm_contributions_80years_Jul_Aug_do_rcp85 + param_contributions_80years_Jul_Aug_do_rcp85, gcm_contributions_80years_Jul_Aug_do_rcp85 + param_contributions_80years_Jul_Aug_do_rcp85 + interact_contributions_80years_Jul_Aug_do_rcp85, label='Interactions', alpha=0.7, color=colors[2], edgecolor='black')
axs[2].set_title('(c) RCP8.5', fontsize=20)
axs[2].set_ylim(0,100)
axs[2].set_xlim(2020, 2099)
axs[2].tick_params(axis='both', which='major', labelsize=20)
...
# Adding labels and title with increased font size
# fig.text(0.5, 0.08, 'Year', ha='center', fontsize=20)
fig.text(0.08, 0.5, 'Uncertainty sources in\n Jul_Aug deep DO [%]', va='center', rotation='vertical', fontsize=22)
...
# Save the plot
plt.savefig('uncertainty_Jul_Aug_do_80years_rcps.png', dpi=300, bbox_inches='tight')
...
#%%sorting the indexs_Jul_Aug_hypolimnetic_ave 

glue_df_Jul_Aug_hypolimnetic_ave_his= glue_df_Jul_Aug_hypolimnetic_ave_his.sort_index()
glue_df_Jul_Aug_hypolimnetic_ave_rcp26= glue_df_Jul_Aug_hypolimnetic_ave_rcp26.sort_index()
glue_df_Jul_Aug_hypolimnetic_ave_rcp60= glue_df_Jul_Aug_hypolimnetic_ave_rcp60.sort_index()
glue_df_Jul_Aug_hypolimnetic_ave_rcp85= glue_df_Jul_Aug_hypolimnetic_ave_rcp85.sort_index()
...
#%%===========Jul-Aug average of anoxic afctor 


#%%ploting Jul_Aug anoxic factor 
...
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_his.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_his['5%'], glue_df_Jul_Aug_hypolimnetic_ave_his['95%'], color='grey', alpha=0.2 ,  label= 'His 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_his.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_his['50%'].astype(float), 'k', label='His median', alpha=0.9, linewidth=3  )



ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp26['5%'], glue_df_Jul_Aug_hypolimnetic_ave_rcp26['95%'], color='darkgreen', alpha=0.3 ,  label= 'RCP2.6 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp26['50%'], 'darkgreen', label='RCP2.6 median', alpha=0.9, linewidth=3  )


ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['5%'], glue_df_Jul_Aug_hypolimnetic_ave_rcp60['95%'], color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%'], 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )

ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['5%'], glue_df_Jul_Aug_hypolimnetic_ave_rcp85['95%'], color='r', alpha=0.2 ,  label= 'RCP8.5 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%'], 'r', label='RCP8.5 median', alpha=0.9, linewidth=3  )

ax=plt.ylabel('Deep DO in Jul-Aug [mg L$^{-1}$]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(1.1, -0.2), fontsize=22, ncol=4)
fig.savefig("GLUE_Timeseries_Jul_Aug_hypolimnetic_ave.png",  dpi=300, bbox_inches='tight')




#%%
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_his['50%'])# 1.8575488594795195
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp26['50%'])#0.7790155643349883
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%'])#0.6201172880532559
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%'])#0.6137840780829922
...
#anormaly 
# baseline [1976-2005]
glue_base_Jul_Aug_hypolimnetic_ave_his=glue_df_Jul_Aug_hypolimnetic_ave_his[1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index]
Jul_Aug_hypolimnetic_ave_ref=np.mean(glue_base_Jul_Aug_hypolimnetic_ave_his['50%'])
#1.6201616358166036
Jul_Aug_hypolimnetic_ave_5=np.mean(glue_base_Jul_Aug_hypolimnetic_ave_his['5%'])
#0.6816042411986403
Jul_Aug_hypolimnetic_ave_95=np.mean(glue_base_Jul_Aug_hypolimnetic_ave_his['95%'])
#3.599316775779948
#std
(Jul_Aug_hypolimnetic_ave_95-Jul_Aug_hypolimnetic_ave_5)/(2*1.645)
#0.8868427156782089


#near future [2030-2059]

glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index < 2060)]
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26['50%'])
#0.7581073322556027
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26['5%'])
#0.10662424285366558
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26['95%'])
#2.443729712633855
#std
#(2.443729712633855-.10662424285366558)/(2*1.645)
#0.7103664041885074



glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index < 2060)]
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
#0.7029590083377801
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60['5%'])
#0.10527978476293821
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60['95%'])
#2.4252589304586007
#std
#(2.4252589304586007-0.10527978476293821)/(2*1.645)
#0.7051608345579522



glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index < 2060)]
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85['50%'])
#0.6515393374504488
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85['5%'])
#0.046890058893932544
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85['95%'])
#2.9656824494853713
#std
#(2.9656824494853713-0.046890058893932544)/(2*1.645)
#0.887170939389495

 
#Distant future [2070-2099]

glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index < 2100)]
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26['50%'])
#0.7646241324603634
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26['5%'])
#0.10778856638751562
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26['95%'])
#2.3266381207974427
#std
#(2.3266381207974427-0.10778856638751562)/(2*1.645)
#0.6744223569635036




glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index< 2100)]
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
#0.2995855976750922
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60['5%'])
#0.0026082995755348694
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60['95%'])
#1.4672987152636474
#std
#(1.4672987152636474-0.2995855976750922)/(2*1.645)
#0.3549279992670381
...
glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index < 2100)]
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85['50%'])
#0.16312864161494778
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85['5%'])
#0.008118810748964473
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85['95%'])
#1.4582374807171923
#std
#(1.4582374807171923-0.008118810748964473)/(2*1.645)
#0.44076555318183214
...
# baseline [1976-2005]
autocorr_MK_org_modif_sens_slope_test(glue_base_Jul_Aug_hypolimnetic_ave_his)
...
autocorr_MK_org_modif_sens_slope_test(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26)
(0.35736178315837047,
 'positively autocorrelated',
 'no trend',
 0.3007717594347785,
...
autocorr_MK_org_modif_sens_slope_test(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60)
(0.4179006515713509,
 'positively autocorrelated',
 'no trend',
 0.12915516898714952,
...
autocorr_MK_org_modif_sens_slope_test(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85)

(0.4574036128122198,
 'positively autocorrelated',
 'decreasing',
 0.04196394457941599,
 -0.015516213185115564,
 0.7764897298109987)
...
autocorr_MK_org_modif_sens_slope_test(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26)
(0.19494291051565676,
 'positively autocorrelated',
 'decreasing',
 0.02950999336955995,
 -0.013911288751376306,
 1.022310445145833)

autocorr_MK_org_modif_sens_slope_test(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60)
(0.9581893352662004,
 'positively autocorrelated',
 'no trend',
 0.28995506566636653,
...
autocorr_MK_org_modif_sens_slope_test(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85)
(1.1838144528984027,
 'positively autocorrelated',
 'no trend',
 0.12494881685497083,
...
#%% 80 years from 2020 for Jul_Aug_hypolimnetic_ave


glue_80years_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26[2019 < glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index]

glue_80years_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60[2019 < glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index]

glue_80years_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85[2019 < glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index]


#============= mean of first 10 yaers over 80 years 

#rcp2.6
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp26[glue_80years_Jul_Aug_hypolimnetic_ave_rcp26.index<2030]['50%'])
0.8047503237650855

#rcp6.0
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60[glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index<2030]['50%'])
0.9072881129731483

#rcp8.5
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85[glue_80years_Jul_Aug_hypolimnetic_ave_rcp85.index<2030]['50%'])
1.052514539567747

#============== mean of last 10 yaers over 80 years 

#rcp2.6
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp26[glue_80years_Jul_Aug_hypolimnetic_ave_rcp26.index>2079]['50%'])
0.7131764918583853

#rcp6.0
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60[glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index>2079]['50%'])
0.27207453910517254

#rcp8.5
np.mean(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85[glue_80years_Jul_Aug_hypolimnetic_ave_rcp85.index>2079]['50%'])
0.14426343854057683

#=========== trendline # Over the 80 years


autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp26['50%'])
(0.33955523762837136,
 'positively autocorrelated',
 'no trend',
 0.46718557289653284,
...
autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
(0.5492080097688486,
 'positively autocorrelated',
 'decreasing',
 0.0,
...
autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['50%'])
(0.43103392328824763,
 'positively autocorrelated',
 'decreasing',
 1.2447820552097255e-12,
 -0.010294682509117758,
 0.767914984219685)

#%%plotting Jul_Aug anoxic factor over 80 years 
...
ax=plt.fill_between(glue_80years_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp26['5%'], glue_80years_Jul_Aug_hypolimnetic_ave_rcp26['95%'], color='darkgreen', alpha=0.3 ,  label= 'RCP2.6 90% CI')
ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp26['50%'], 'darkgreen', label='RCP2.6 median', alpha=0.9, linewidth=3  )


ax=plt.fill_between(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['5%'], glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['95%'], color='yellow', alpha=0.3 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%'], 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )
trendline_rcp60=autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
ax=plt.text(2060, 5.5, f'y = {trendline_rcp60[-2]:.3f}x + {trendline_rcp60[-1]:.3f}, p <0.0001', color='gold', fontsize= 20 )

ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float),
        trendline_rcp60[-2] * np.arange(80) + trendline_rcp60[-1],
        linestyle='--', color='yellow', alpha=0.9, linewidth=3)


ax=plt.fill_between(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['5%'], glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['95%'], color='r', alpha=0.2 ,  label= 'RCP8.5 90% CI')
ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['50%'], 'r', label='RCP8.5 median', alpha=0.9, linewidth=3  )
trendline_rcp85=autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['50%'])
ax=plt.text(2060, 6, f'y = {trendline_rcp85[-2]:.3f}x + {trendline_rcp85[-1]:.3f},  p<0.0001', color='r', fontsize= 20 )


ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float),
...
ax=plt.ylabel('Deep-water average DO in Jul-Aug [mg L$^{-1}$]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.95, -0.2), fontsize=22 , ncol= 3)   
fig.savefig("GLUE_Timeseries_80years_Jul_Aug_hypolimnetic_ave.png",  dpi=300, bbox_inches='tight')
...
# in whole his
autocorr_MK_org_modif_sens_slope_test(glue_df_Jul_Aug_hypolimnetic_ave_his['50%'])
(0.3536383311759351,
 'positively autocorrelated',
 'decreasing',
 0.03176092080297632,
 -0.002789878805163935,
 1.9159132465198294)
#in entire rcp2.6
autocorr_MK_org_modif_sens_slope_test(glue_df_Jul_Aug_hypolimnetic_ave_rcp26['50%'])
(0.31032675365499224,
 'positively autocorrelated',
 'no trend',
 0.06100070397142665,
...
#in entire rcp6.0
autocorr_MK_org_modif_sens_slope_test(glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
(0.4995857949575755,
 'positively autocorrelated',
 'decreasing',
 0.0,
 -0.009046490749457615,
 0.9087565635136539)
#in entire rcp8.5
autocorr_MK_org_modif_sens_slope_test(glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%'])
(0.42149072515065444,
 'positively autocorrelated',
 'decreasing',
 2.220446049250313e-16,
 -0.012416217656948522,
 0.9874866768815812)
...
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_his[(1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index)].index.astype(float),
                      glue_df_Jul_Aug_hypolimnetic_ave_his[(1975< glue_df_Jul_Aug_hypolimnetic_ave_his.index)]['5%'] - Jul_Aug_hypolimnetic_ave_ref,
                      glue_df_Jul_Aug_hypolimnetic_ave_his[(1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index) ]['95%'] - Jul_Aug_hypolimnetic_ave_ref,
                      color='grey', alpha=0.2, label='His 90% CI')


ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_his[(1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index) ].index.astype(float),
            glue_df_Jul_Aug_hypolimnetic_ave_his[(1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index)]['50%'] - Jul_Aug_hypolimnetic_ave_ref,
            'k', label='His median', alpha=0.9, linewidth=3   )

ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp26['5%']-Jul_Aug_hypolimnetic_ave_ref, glue_df_Jul_Aug_hypolimnetic_ave_rcp26['95%']-Jul_Aug_hypolimnetic_ave_ref, color='darkgreen', alpha=0.3 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp26['50%']-Jul_Aug_hypolimnetic_ave_ref, 'darkgreen', label='RCP6.0 median', alpha=0.9, linewidth=3  )
                   
                     
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['5%']-Jul_Aug_hypolimnetic_ave_ref, glue_df_Jul_Aug_hypolimnetic_ave_rcp60['95%']-Jul_Aug_hypolimnetic_ave_ref, color='yellow', alpha=0.3 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%']-Jul_Aug_hypolimnetic_ave_ref, 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )
trendline_rcp60=autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%']-Jul_Aug_hypolimnetic_ave_ref)
ax=plt.text(2040, 6.5, f'y = {trendline_rcp60[-2]:.3f}x {trendline_rcp60[-1]:.3f}, p <0.0001', color='orange', fontsize= 24 )
...
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['5%']-Jul_Aug_hypolimnetic_ave_ref, glue_df_Jul_Aug_hypolimnetic_ave_rcp85['95%']-Jul_Aug_hypolimnetic_ave_ref, color='r', alpha=0.2 ,  label= 'RCP8.5 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%']-Jul_Aug_hypolimnetic_ave_ref, 'r', label='RCP8.5 median', alpha=0.9, linewidth=3  )
trendline_rcp85=autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp85['50%']-Jul_Aug_hypolimnetic_ave_ref)
ax=plt.text(2040, 6, f'y = {trendline_rcp85[-2]:.3f}x {trendline_rcp85[-1]:.3f},  p<0.0001', color='r', fontsize= 24 )
...
ax=plt.text(1974, 7.8, 'n=64', color='k', fontsize= 24 )
ax=plt.ylabel('Deep-water DO in Jul-Aug anomal [mg L$^{-1}$]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.95, -0.2), fontsize=22, ncol=3)  
fig.savefig("GLUE_Timeseries_Jul_Aug_hypolimnetic_ave_anormaly.png",  dpi=300, bbox_inches='tight')
...
all_Jul_Aug_do_rcp26_test= pd.DataFrame([])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("DO_prof_gfdl_rcp26"):
        ...
        result_Jul_Aug =Jul_Aug_hypolimnetic_ave (C, Vr, time_series )
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_gfdl_rcp26"):
        ...
        all_Jul_Aug_do_rcp26_test= pd.concat([all_Jul_Aug_do_rcp26_test , result_Jul_Aug], axis=1)
        ...
        # Save the result Jul_Aug to a new CSV file
        result_Jul_Aug_filename = f'Jul_Aug_do_gfdl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
        
        header_df = pd.DataFrame([header_values])
        header_df.to_csv(os.path.join(directory, result_Jul_Aug_filename))#, index=False)
       

        result_Jul_Aug.to_csv(os.path.join(directory, result_Jul_Aug_filename) , mode='a' , index_label='year', na_rep='NaN', header=['Jul_Aug_AF'])
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_hadgem_rcp26"):
        ...
        # Save the result Jul_Aug to a new CSV file
        result_Jul_Aug_filename = f'Jul_Aug_do_hadgem_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_ipsl_rcp26"):
        ...
        # Save the result Jul_Aug to a new CSV file
        result_Jul_Aug_filename = f'Jul_Aug_do_ipsl_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("mixingincl_DO_prof_miroc_rcp26"):
        ...
        # Save the result Jul_Aug to a new CSV file
        result_Jul_Aug_filename = f'Jul_Aug_do_miroc_his_Jv_{Jv_name}_Ja_{Ja_name}.csv'
...
#%% GLUE of diff of test rcp26 scenarios for annual/Jul_Aug/summer do


all_annual_do_rcp26_test
all_Jul_Aug_do_rcp26_test
#all_summer_do_rcp26_test

all_annual_do_rcp26
all_Jul_Aug_do_rcp26
#all_summer_do_rcp26


diff_base_test_annual_do_rcp26= pd.DataFrame(np.array(all_annual_do_rcp26)-np.array(all_annual_do_rcp26_test))

diff_base_test_Jul_Aug_do_rcp26= pd.DataFrame(np.array(all_Jul_Aug_do_rcp26)-np.array(all_Jul_Aug_do_rcp26_test))
...
# Jul_Aug DO hypolimnion 
timeseries_year_rcp26= all_Jul_Aug_do_rcp26_test.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in diff_base_test_Jul_Aug_do_rcp26.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_diff_base_test_Jul_Aug_do_rcp26 = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_diff_base_test_Jul_Aug_do_rcp26=glue_diff_base_test_Jul_Aug_do_rcp26.set_index(timeseries_year_rcp26)    
glue_diff_base_test_Jul_Aug_do_rcp26=glue_diff_base_test_Jul_Aug_do_rcp26.sort_index()
glue_diff_base_test_Jul_Aug_do_rcp26_80years=glue_diff_base_test_Jul_Aug_do_rcp26[glue_diff_base_test_Jul_Aug_do_rcp26.index>2019]
"""
...
quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_do_rcp26_test.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))

# Build glue df
glue_Jul_Aug_do_rcp26_test = pd.DataFrame(data=out, columns=['5%', '50%', '95%'])
    
glue_Jul_Aug_do_rcp26_test=glue_Jul_Aug_do_rcp26_test.set_index(timeseries_year_rcp26)    
glue_Jul_Aug_do_rcp26_test=glue_Jul_Aug_do_rcp26_test.sort_index()
glue_Jul_Aug_do_rcp26_test_80years=glue_Jul_Aug_do_rcp26_test[glue_Jul_Aug_do_rcp26_test.index>2019]
...
glue_diff_base_test_Jul_Aug_do_rcp26_80years=glue_diff_base_test_Jul_Aug_do_rcp26[glue_diff_base_test_Jul_Aug_do_rcp26.index>2019]
autocorr_MK_org_modif_sens_slope_test(glue_diff_base_test_Jul_Aug_do_rcp26_80years['50%'])
...
autocorr_MK_org_modif_sens_slope_test(glue_Jul_Aug_do_rcp26_test_80years['50%'])
(0.00890653300478083,
 'positively autocorrelated',
 'decreasing',
...
#%%for paper both plot of diff and test of Jul_Aug rcp26 in one plot 
...
ax = axs[1]
ax.fill_between(glue_diff_base_test_Jul_Aug_do_rcp26_80years.index,
                glue_diff_base_test_Jul_Aug_do_rcp26_80years['5%'],
                glue_diff_base_test_Jul_Aug_do_rcp26_80years['95%'],
                color='green', alpha=0.2, label='90% CI')
ax.plot(glue_diff_base_test_Jul_Aug_do_rcp26_80years.index,
        glue_diff_base_test_Jul_Aug_do_rcp26_80years['50%'],
        'green', label='Median', alpha=0.9, linewidth=3)

# Add trendline
trendline_rcp26_1 = autocorr_MK_org_modif_sens_slope_test(glue_diff_base_test_Jul_Aug_do_rcp26_80years['50%'])
...
ax.plot(glue_diff_base_test_Jul_Aug_do_rcp26_80years.index.astype(float),
        trendline_rcp26_1[-2] * np.arange(80) + trendline_rcp26_1[-1],
        linestyle='--', color='green', alpha=0.9, linewidth=3)

# Set labels for the first subplot
ax.set_ylabel('Deep DO in Jul-Aug of RCP2.6 \n difference between fixed initial condition \n and original scenario  [mg L$^{-1}$]', fontsize=26)
ax.set_xlabel('Year', fontsize=26)
ax.tick_params(axis='y', labelsize=22)
ax.set_xticks(glue_diff_base_test_Jul_Aug_do_rcp26_80years.index)
ax.set_xticklabels(glue_diff_base_test_Jul_Aug_do_rcp26_80years.index, rotation=45, fontsize=22)
ax.xaxis.set_major_locator(MaxNLocator(prune='both'))

# Plot for the second subplot
ax = axs[0]
ax.fill_between(glue_Jul_Aug_do_rcp26_test_80years.index,
                glue_Jul_Aug_do_rcp26_test_80years['5%'],
                glue_Jul_Aug_do_rcp26_test_80years['95%'],
                color='green', alpha=0.2)#, label='90% CI')
ax.plot(glue_Jul_Aug_do_rcp26_test_80years.index,
        glue_Jul_Aug_do_rcp26_test_80years['50%'].astype(float),
        'green', alpha=0.9, linewidth=3)# label='Median',

# Add trendline
trendline_rcp26_0 = autocorr_MK_org_modif_sens_slope_test(glue_Jul_Aug_do_rcp26_test_80years['50%'])
...
ax.set_ylabel('Deep DO in Jul-Aug of RCP2.6 with\n fixed initial condition [mg L$^{-1}$]', fontsize=26)
ax.set_xlabel('Year', fontsize=26)
ax.tick_params(axis='y', labelsize=22)
ax.set_xticks(glue_Jul_Aug_do_rcp26_test_80years.index)
ax.set_xticklabels(glue_Jul_Aug_do_rcp26_test_80years.index, rotation=45, fontsize=22)
ax.xaxis.set_major_locator(MaxNLocator(prune='both'))
...
plt.savefig("atttest_difference_test_initalcondition_fixed_Jul_Aug_do_80years_rcp26.png",  dpi=300, bbox_inches='tight')




#%%
glue_diff_base_test_Jul_Aug_do_rcp26_80years
glue_Jul_Aug_do_rcp26_test_80years
...
ax=plt.fill_between(glue_Jul_Aug_do_rcp26_test_80years.index.astype(float), glue_Jul_Aug_do_rcp26_test_80years['5%'], glue_Jul_Aug_do_rcp26_test_80years['95%'], color='green', alpha=0.2 ,  label= '90% CI')
ax=plt.plot(glue_Jul_Aug_do_rcp26_test_80years.index.astype(float), glue_Jul_Aug_do_rcp26_test_80years['50%'].astype(float), 'green', label='Median', alpha=0.9, linewidth=3  )




trendline_rcp26=autocorr_MK_org_modif_sens_slope_test(glue_Jul_Aug_do_rcp26_test_80years['50%'])
ax=plt.text(2020, 2, f'y = {trendline_rcp26[-2]:.3f}x + {trendline_rcp26[-1]:.3f}, p = {trendline_rcp26[-3]:.3f}', color='green', fontsize= 20 )

ax=plt.plot(glue_Jul_Aug_do_rcp26_test_80years.index.astype(float),
        trendline_rcp26[-2] * np.arange(80) + trendline_rcp26[-1],
        linestyle='--', color='green', alpha=0.9, linewidth=3)
...
ax=plt.ylabel('Deep DO in Jul-Aug of RCP2.6 with fixed inital condition [mg L$^{-1}$]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)#)   
fig.savefig("test_initalcondition_fixed_Jul_Aug_do_80years_rcp26.png",  dpi=300, bbox_inches='tight')
...
#%% Jul_Aug anoxic factor_gfdl_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/his'
...
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("DO_prof_gfdl_his_Jv_"):
        ...
        # Apply the annual_hypolimnetic_ave function
        result = Jul_Aug_hypolimnetic_ave(C, Vr, time_series A0=23.67*10**6 , threshold=2)
...
#%% Jul_Aug anoxic factor_gfdl_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp26'
...
#%% Jul_Aug anoxic factor_gfdl_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp60'
...
#%% Jul_Aug anoxic factor_gfdl_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp85'
...
#%% Jul_Aug anoxic factor_hadgem_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/hadgem_senarios/his'
...
#%% Jul_Aug anoxic factor_hadgem_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/hadgem_senarios/rcp26'
...
#%% Jul_Aug anoxic factor_hadgem_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/hadgem_senarios/rcp60'
...
#%% Jul_Aug anoxic factor_hadgem_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/hadgem_senarios/rcp85'
...
#%% Jul_Aug anoxic factor_ipsl_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/ipsl_senarios/his'
...
#%% Jul_Aug anoxic factor_ipsl_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/ipsl_senarios/rcp26'
...
#%% Jul_Aug anoxic factor_ipsl_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/ipsl_senarios/rcp60'
...
#%% Jul_Aug anoxic factor_ipsl_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/ipsl_senarios/rcp85'
...
#%% Jul_Aug anoxic factor_miroc_his
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/miroc_senarios/his'
...
#%% Jul_Aug anoxic factor_miroc_rcp26
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/miroc_senarios/rcp26'
...
#%% Jul_Aug anoxic factor_miroc_rcp60
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/miroc_senarios/rcp60'
...
#%% Jul_Aug anoxic factor_miroc_rcp85
# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/miroc_senarios/rcp85'
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_df_anoxic_factor_his.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_anoxic_factor_rcp26.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_anoxic_factor_rcp60.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_anoxic_factor_rcp85.csv')
...
#%% Jul_Aug anoxic factor
#%%his_Jul_Aug_hypolimnetic_ave


# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/his'
all_Jul_Aug_hypolimnetic_ave_his= pd.DataFrame([])
all_weights= np.array([])


# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_gfdl_his"):
        ...
        # Read the DataFrame below the header
        Jul_Aug_hypolimnetic_ave = pd.read_csv(os.path.join(directory, filename), skiprows=2)
        Jul_Aug_hypolimnetic_ave=Jul_Aug_hypolimnetic_ave.set_index(Jul_Aug_hypolimnetic_ave.index)
        
        all_Jul_Aug_hypolimnetic_ave_his = pd.concat([all_Jul_Aug_hypolimnetic_ave_his , Jul_Aug_hypolimnetic_ave['Jul_Aug_hypolimnetic_ave']], axis=1)
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_hadgem_his"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_ipsl_his"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_miroc_his"):
...
all_Jul_Aug_hypolimnetic_ave_his= all_Jul_Aug_hypolimnetic_ave_his.set_index(Jul_Aug_hypolimnetic_ave['year'])


# Jul_Aug anoxic duration  
timeseries_year_his= all_Jul_Aug_hypolimnetic_ave_his.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_hypolimnetic_ave_his.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_df_anoxic_factor_his.csv')


#%%rcp26_Jul_Aug_hypolimnetic_ave


# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp26'
all_Jul_Aug_hypolimnetic_ave_rcp26= pd.DataFrame([])
all_weights= np.array([])


# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_gfdl_rcp26"):
        ...
        all_Jul_Aug_hypolimnetic_ave_rcp26 = pd.concat([all_Jul_Aug_hypolimnetic_ave_rcp26 , Jul_Aug_hypolimnetic_ave['Jul_Aug_hypolimnetic_ave']], axis=1)
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_hadgem_rcp26"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_ipsl_rcp26"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_miroc_rcp26"):
...
all_Jul_Aug_hypolimnetic_ave_rcp26= all_Jul_Aug_hypolimnetic_ave_rcp26.set_index(Jul_Aug_hypolimnetic_ave['year'])

# Jul_Aug anoxic duration  
timeseries_year_rcp26= all_Jul_Aug_hypolimnetic_ave_rcp26.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_hypolimnetic_ave_rcp26.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_anoxic_factor_rcp26.csv')


#%%rcp60_Jul_Aug_hypolimnetic_ave


# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp60'
all_Jul_Aug_hypolimnetic_ave_rcp60= pd.DataFrame([])
all_weights= np.array([])


# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_gfdl_rcp60"):
        ...
        all_Jul_Aug_hypolimnetic_ave_rcp60 = pd.concat([all_Jul_Aug_hypolimnetic_ave_rcp60 , Jul_Aug_hypolimnetic_ave['Jul_Aug_hypolimnetic_ave']], axis=1)
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_hadgem_rcp60"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_ipsl_rcp60"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_miroc_rcp60"):
...
all_Jul_Aug_hypolimnetic_ave_rcp60= all_Jul_Aug_hypolimnetic_ave_rcp60.set_index(Jul_Aug_hypolimnetic_ave['year'])

# Jul_Aug anoxic duration  
timeseries_year_rcp60= all_Jul_Aug_hypolimnetic_ave_rcp60.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_hypolimnetic_ave_rcp60.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_anoxic_factor_rcp60.csv')

#%%rcp85_Jul_Aug_hypolimnetic_ave


# Specify the directory where the CSV files are located
directory = 'C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/gfdl_senarios/rcp85'
all_Jul_Aug_hypolimnetic_ave_rcp85= pd.DataFrame([])
all_weights= np.array([])


# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_gfdl_rcp85"):
        ...
        all_Jul_Aug_hypolimnetic_ave_rcp85 = pd.concat([all_Jul_Aug_hypolimnetic_ave_rcp85 , Jul_Aug_hypolimnetic_ave['Jul_Aug_hypolimnetic_ave']], axis=1)
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_hadgem_rcp85"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_ipsl_rcp85"):
...
# Loop through each CSV file in the directory
for filename in os.listdir(directory):
    if filename.endswith(".csv") and filename.startswith("Jul_Aug_hypolimnetic_ave_miroc_rcp85"):
...
all_Jul_Aug_hypolimnetic_ave_rcp85= all_Jul_Aug_hypolimnetic_ave_rcp85.set_index(Jul_Aug_hypolimnetic_ave['year'])


# Jul_Aug anoxic duration  
timeseries_year_rcp85= all_Jul_Aug_hypolimnetic_ave_rcp85.index

quants = [0.05 ,0.5 , 0.95 ]#[0,1]#[0.025, 0.5, 0.975]    
out=[]    
for index, row in all_Jul_Aug_hypolimnetic_ave_rcp85.iterrows():# for each timesteps
    #values = row    
    values = pd.to_numeric(row, errors='coerce') 
    out.append(weighted_quantiles(values, quants, sample_weight=all_weights))
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_Jul_Aug_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_anoxic_factor_rcp85.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his/glue_df_anoxic_factor_his.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp26/glue_df_anoxic_factor_rcp26.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp60/glue_df_anoxic_factor_rcp60.csv')
...
# Use to_csv to save the DataFrame to a CSV file in the specified directory
glue_df_summer_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/rcp85/glue_df_anoxic_factor_rcp85.csv')
...
ax=plt.ylabel('Anoxic factor Jul-Aug [d]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)#)   
...
#%%
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_his['50%'])#6.077082662821386
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp26['50%'])#7.992767795524755
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%'])#8.585258963812871
np.mean(glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%'])#9.149586881905822
...
#anormaly 
# baseline [1976-2005]
glue_base_Jul_Aug_hypolimnetic_ave_his=glue_df_Jul_Aug_hypolimnetic_ave_his[1975 < glue_df_Jul_Aug_hypolimnetic_ave_his.index]['50%']
Jul_Aug_hypolimnetic_ave_ref=np.mean(glue_base_Jul_Aug_hypolimnetic_ave_his)
#6.389027950812897


#near future [2030-2059]

glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index < 2060)]['50%']
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp26)
# 8.070525139552648
glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index < 2060)]['50%']
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp60)
# 8.107889314159742
glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85[(2029 < glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index < 2060)]['50%']
np.mean(glue_near_future_Jul_Aug_hypolimnetic_ave_rcp85)
# 8.63044924136971

 
#Distant future [2070-2099]

glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26=glue_df_Jul_Aug_hypolimnetic_ave_rcp26[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp26.index < 2100)]['50%']
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp26)
#8.153608896799094
glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60=glue_df_Jul_Aug_hypolimnetic_ave_rcp60[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index< 2100)]['50%']
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp60)
#9.787975473676404
glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85=glue_df_Jul_Aug_hypolimnetic_ave_rcp85[(2069 < glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index) & (glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index < 2100)]['50%']
np.mean(glue_distant_future_Jul_Aug_hypolimnetic_ave_rcp85)
#10.963418155408705
...
ax=plt.fill_between(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['5%'], glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['95%'], color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%'], 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )
trendline_rcp60=autocorr_MK_org_modif_sens_slope_test(glue_80years_Jul_Aug_hypolimnetic_ave_rcp60['50%'])
...
ax=plt.ylabel('anoxic factor in Jul_Aug [d/year]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)#)   
...
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_his[(1960 < glue_df_Jul_Aug_hypolimnetic_ave_his.index)].index.astype(float),
                      glue_df_Jul_Aug_hypolimnetic_ave_his[(1960 < glue_df_Jul_Aug_hypolimnetic_ave_his.index)]['5%'] - Jul_Aug_hypolimnetic_ave_ref,
                      glue_df_Jul_Aug_hypolimnetic_ave_his[(1960 < glue_df_Jul_Aug_hypolimnetic_ave_his.index) ]['95%'] - Jul_Aug_hypolimnetic_ave_ref,
                      color='grey', alpha=0.2, label='His 90% CI')


ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_his[(1960 < glue_df_Jul_Aug_hypolimnetic_ave_his.index) ].index.astype(float),
            glue_df_Jul_Aug_hypolimnetic_ave_his[(1960 < glue_df_Jul_Aug_hypolimnetic_ave_his.index)]['50%'] - Jul_Aug_hypolimnetic_ave_ref,
            'k', label='His median', alpha=0.9, linewidth=3   )
...
ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['5%']-Jul_Aug_hypolimnetic_ave_ref, glue_df_Jul_Aug_hypolimnetic_ave_rcp60['95%']-Jul_Aug_hypolimnetic_ave_ref, color='yellow', alpha=0.2 ,  label= 'RCP6.0 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp60.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp60['50%']-Jul_Aug_hypolimnetic_ave_ref, 'yellow', label='RCP6.0 median', alpha=0.9, linewidth=3  )

ax=plt.fill_between(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['5%']-Jul_Aug_hypolimnetic_ave_ref, glue_df_Jul_Aug_hypolimnetic_ave_rcp85['95%']-Jul_Aug_hypolimnetic_ave_ref, color='r', alpha=0.2 ,  label= 'RCP8.5 90% CI')
ax=plt.plot(glue_df_Jul_Aug_hypolimnetic_ave_rcp85.index.astype(float), glue_df_Jul_Aug_hypolimnetic_ave_rcp85['50%']-Jul_Aug_hypolimnetic_ave_ref, 'r', label='RCP8.5 median', alpha=0.9, linewidth=3  )

ax=plt.ylabel('Anormaly of anoxic factor in Jul-Aug [d year$^{-1}$]' , fontsize=26)
ax=plt.xlabel('Year' , fontsize=26)
ax=plt.yticks(fontsize= 22)
ax=plt.xticks(rotation=45 , fontsize=22)
ax=plt.legend(bbox_to_anchor=(0.7, -0.2), fontsize=22)  
...
######## fixed theta both in calib and simulation 
#########glue_df_annual_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his_fixedtheta/glue_df_anoxic_factor_his.csv')



####### test with fixed theta in calibration but variable for GOTM simulation 
glue_df_annual_hypolimnetic_ave_his.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/his_calibinfixedtheta_simuvartheta/glue_df_anoxic_factor_his.csv')
...
#########original test with variable theta:
#########glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther/glue_df_anoxic_factor_rcp26.csv')


######## fixed theta both in calib and simulation 
#########glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta/glue_df_anoxic_factor_rcp26.csv')


###### test with fixed theta in calibration a temp ave hypo in ipcl rcp26 for years 2020 and 2021
#########glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta_temp_gcms_2020_2021/glue_df_anoxic_factor_rcp26.csv')


####### test with fixed theta in calibration but variable for GOTM simulation 
glue_df_annual_hypolimnetic_ave_rcp26.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_calibinfixedtheta_simuvartheta/glue_df_anoxic_factor_rcp26.csv')
...
#########original test with variable theta:
#########glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther/glue_df_anoxic_factor_rcp60.csv')


######## fixed theta both in calib and simulation 
#########glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta/glue_df_anoxic_factor_rcp60.csv')


###### test with fixed theta in calibration a temp ave hypo in ipcl rcp60 for years 2020 and 2021
#########glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta_temp_gcms_2020_2021/glue_df_anoxic_factor_rcp60.csv')


####### test with fixed theta in calibration but variable for GOTM simulation 
glue_df_annual_hypolimnetic_ave_rcp60.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_calibinfixedtheta_simuvartheta/glue_df_anoxic_factor_rcp60.csv')
...
#########original test with variable theta:
#########glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther/glue_df_anoxic_factor_rcp85.csv')


######## fixed theta both in calib and simulation 
#########glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta/glue_df_anoxic_factor_rcp85.csv')


###### test with fixed theta in calibration a temp ave hypo in ipcl rcp85 for years 2020 and 2021
#########glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_fixedtheta_temp_gcms_2020_2021/glue_df_anoxic_factor_rcp85.csv')


####### test with fixed theta in calibration but variable for GOTM simulation 
glue_df_annual_hypolimnetic_ave_rcp85.to_csv('C:/Users/mahta/OneDrive/Documents/Chapter_1_PhD_py_codes_results/Future_simulation_results/all_4_models/alltogther_calibinfixedtheta_simuvartheta/glue_df_anoxic_factor_rcp85.csv')
